...
typealias DurationAsInt = @Serializable(DurationSerializer::class) Duration

object DurationSerializer : KSerializer<Duration> {

    override val descriptor: SerialDescriptor = PrimitiveSerialDescriptor("DurationAsInt", PrimitiveKind.LONG)

    override fun deserialize(decoder: Decoder): Duration {
        val structure = decoder.beginStructure(descriptor) as YamlInput
        return structure.decodeLong().milliseconds
    }
