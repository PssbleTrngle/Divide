...
object TeamCommand {
    ...
    private val TEAM_ALREADY_EXISTS =
        SimpleCommandExceptionType(Component.translatable("commands.team.add.duplicate"))
    ...
    private fun addToTeam(ctx: CommandContext<CommandSourceStack>): Int {
        ...
        ctx.source.sendSuccess(Component.literal("added ${players.size} players to team"), true)
    ...
    private fun removeTeam(ctx: CommandContext<CommandSourceStack>): Int {
        ...
        ctx.source.sendSuccess(Component.literal("removed team"), true)
    ...
    private fun createTeam(ctx: CommandContext<CommandSourceStack>): Int {
        ...
        ctx.source.sendSuccess(Component.translatable("commands.team.add.success", team.formattedDisplayName), true)
        return scoreboard.teamNames.size
    }
